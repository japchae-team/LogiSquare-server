...
public class Item extends BaseTimeEntity {
    ...
    @Column(name = "rotation_grade", length = 30)
    private String rotationGrade;

    @Column(name = "default_unit_qty", nullable = false)
    private Integer defaultUnitQty;

    public Item(String sku, String name, String category, String rotationGrade, Integer defaultUnitQty) {
        this.sku = sku;
        this.name = name;
